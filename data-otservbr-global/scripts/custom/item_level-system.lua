local config = {
    maxLevel = 30, --MAX LEVEL ITEM CAN REACH
    stonesId = {["32724"] = 100, ["32725"] = 50} -- [itemId] = chance -- CHANCE WILL DECREASE PER LEVEL, CALCULATE: CHANCE / LEVEL
}
