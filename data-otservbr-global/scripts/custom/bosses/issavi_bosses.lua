local config = {
	[1] = {
		teleportPosition = { x = 33801, y = 31473, z = 8 },
		bossName = "Xogixath",
		requiredLevel = 250,
		timeToFightAgain = 10, -- In hour
		timeToDefeat = 10, -- In minutes
		destination = Position(33756, 31454, 8),
		bossPosition = Position(33759, 31445, 8),
		specPos = {
			from = Position(33747, 31440, 8),
			to = Position(33769, 31457, 8),
		},
		exitPosition = Position(33801, 31475, 8),
	},
	[2] = {
		teleportPosition = { x = 33928, y = 31450, z = 9 },
		bossName = "Mozradek",
		requiredLevel = 250,
		timeToFightAgain = 10, -- In hour
		timeToDefeat = 10, -- In minutes
		destination = Position(33990, 31426, 9),
		bossPosition = Position(33992, 31435, 9),
		specPos = {
			from = Position(33986, 31424, 9),
			to = Position(33996, 31437, 9),
		},
		exitPosition = Position(33931, 31450, 9),
	},
	[3] = {
		teleportPosition = { x = 33811, y = 31596, z = 8 },
		bossName = "Bragrumol",
		requiredLevel = 250,
		timeToFightAgain = 10, -- In hour
		timeToDefeat = 10, -- In minutes
		destination = Position(33774, 31596, 8),
		bossPosition = Position(33786, 31598, 8),
		specPos = {
			from = Position(33769, 31591, 8),
			to = Position(33789, 31605, 8),
		},
		exitPosition = Position(33808, 31596, 8),
	},
	[4] = {
		teleportPosition = { x = 33754, y = 31449, z = 8 },
		exitPosition = Position(33801, 31475, 8),
	},
	[5] = {
		teleportPosition = { x = 33992, y = 31425, z = 9 },
		exitPosition = Position(33931, 31450, 9),
	},
	[6] = {
		teleportPosition = { x = 33772, y = 31597, z = 8 },
		exitPosition = Position(33808, 31596, 8),
	},
}
