...
monster.attacks = {
	{name = "melee", interval = 2000, chance = 100, minDamage = -196, maxDamage = -1352, condition = { type = CONDITION_FIRE, totalDamage = 400, interval = 9000 } },
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -362, maxDamage = -1430, radius = 4, effect = CONST_ME_FIREAREA, target = true},
	{name ="sineaterwave", interval = 2000, chance = 17, minDamage = -218, maxDamage = -2445, target = false},
    {name ="combat", interval = 2000, chance = 18, type = COMBAT_DEATHDAMAGE, minDamage = -425, maxDamage = -1454, effect = CONST_ME_BIG_SCRATCH, target = false},
