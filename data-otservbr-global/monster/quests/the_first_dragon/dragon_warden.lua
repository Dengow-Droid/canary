...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 180, attack = 80 },
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -1230, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false },
}
