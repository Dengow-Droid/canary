...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 280, attack = 110 },
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -450, maxDamage = -2720, range = 7, radius = 3, effect = CONST_ME_HITBYFIRE, target = false },
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_FIREDAMAGE, minDamage = -750, maxDamage = -2880, length = 8, spread = 3, effect = CONST_ME_HITBYFIRE, target = false },
}
